...
def bfs():
    ...
    while frontier.size > 0:
        ...
        # Step B: The inputs are unique, so skip redundant uniqueness preprocessing.
        # Eliminate states already visited in previous generations.
        already_seen_mask = cp.in1d(unique_next_pool, visited_buf[:visited_size], assume_unique=True)
